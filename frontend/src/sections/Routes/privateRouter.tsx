...
const ListMonitor = lazy(() => import('../page/ListMonitor'))
const ListFinantialPrinter = lazy(() => import('../page/ListFinantialPrinter'))
const ListPartAndPieces = lazy(() => import('../page/ListPartAndPieces'))
const ListPrinters = lazy(() => import('../page/ListPrinters'))
