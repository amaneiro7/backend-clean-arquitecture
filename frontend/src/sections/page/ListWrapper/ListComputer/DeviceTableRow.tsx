...
const TableCell = lazy(async () => import("@/sections/components/TableComponent/TableCell"))
const TableCellEditDeleteIcon = lazy(async () => import("@/sections/components/TableComponent/TableCellEditDeleteIcon"))
