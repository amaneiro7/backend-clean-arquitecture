...
export function Nav({ isActive }: { isActive: boolean }) {
  return (
    <nav
      className={`-right-2/3 fixed top-24 p-8 max-w-2/3 md:w-1/2 overflow-auto z-40 text-white bg-secondary-950/95 transition-transform transform-gpu will-change-transform duration-300 ease-in-out ${
