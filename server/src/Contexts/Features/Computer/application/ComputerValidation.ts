...
export class ComputerValidation {
  ...
  async run ({ serial, activo, statusId, categoryId, brandId, modelId, employeeId, observation, locationId, processorId, memoryRamCapacity, operatingSystemArqId, operatingSystemId, hardDriveCapacityId, hardDriveTypeId, ipAddress, macAddress }: Omit<DeviceComputerPrimitives, 'id'>): Promise<DeviceComputer> {
    ...
    return DeviceComputer.create({ serial, activo, statusId, categoryId, brandId, modelId, employeeId, observation, locationId, processorId, memoryRamCapacity, operatingSystemArqId, operatingSystemId, hardDriveCapacityId, hardDriveTypeId, ipAddress, macAddress })
  }
}
