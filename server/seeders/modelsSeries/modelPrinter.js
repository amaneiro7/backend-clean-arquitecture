...
const modelPrinterName = {
  HIGHPRINT4915: 'HighPrint 4915',
  'HIGHPRINT4915+': 'HighPrint 4915+',
  HIGHPRINT4915XE: 'HighPrint 4915xe',
  OLIVETTIPR2: 'Olivetti PR2'
}
...
const modelPrinter = [
    { 
      ...
      brandId: brandsData.filter(category => category.name === brandOnlyName["WINCOR-NIXDORF"])[0].id
    },
    { 
