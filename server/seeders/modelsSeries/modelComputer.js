...
const modelName = {
  ...
  HPELITEDESK800G1SFF: 'HP EliteDesk 800 G1 SFF',
  HPELITEDESK800G4SFF: 'HP EliteDesk 800 G4 SFF',
  HPCOMPAQPRO4300SFFPC: 'HP Compaq Pro 4300 SFF PC',
  HPCOMPAQPRO6300SFF: 'HP Compaq Pro 6300 SFF',
  HPCOMPAQ6000PROSFFPC: 'HP Compaq 6000 Pro SFF PC',
  HPCOMPAQ6200PROSFFPC: 'HP Compaq 6200 Pro SFF PC',
  HPCOMPAQDC5700SMALLFORMFACTOR: 'HP Compaq dc5700 Small Form Factor',
  HPPROLIANTML110GEN9: 'HP Proliant ML110 Gen9',
  HPCOMPAQDC5800SMALLFORMFACTOR: 'HP Compaq dc5800 Small Form Factor',
  HPCOMPAQDC5100SMALLFORMFACTOR: 'HP Compaq dc5100 Small Form Factor',
  HP200G1MT: 'HP 200 G1 MT',
  HPELITEBOOK8470P: 'HP EliteBook 8470p',
  HPELITEBOOKX3601030G3: 'HP EliteBook x360 1030 G3',
  HPELITEBOOKX360830G6: 'HP EliteBook x360 830 G6',
  HPLAPTOP15TDY200: 'HP Laptop 15t dy200',
  HPELITEBOOK1040G4: 'HP EliteBook 1040 G4',
  HPPROBOOK4440S: 'HP ProBook 4440s',
  LATITUDE5300: 'Latitude 5300',
...
const modelComputer = [    
    ...
    { 
      ...
      categoryId: categoryData.filter(category => category.name === categoryOnlyNames.COMPUTADORAS)[0].id, 
      brandId: brandsData.filter(brand => brand.name === brandOnlyName.LENOVO)[0].id,
      processorSocketId: processorSockets.filter(processorSocket => processorSocket.name === 'LGA 1151')[0].id,
    ...
    { 
      ...
      brandId: brandsData.filter(brand => brand.name === brandOnlyName.HP)[0].id,
      processorSocketId: processorSockets.filter(processorSocket => processorSocket.name === 'FCLGA 2011')[0].id, 
      memoryRamTypeId: memoryRamType.filter(memory => memory.name === memoryRamTypeName.DDR4)[0].id,
    ...
    { 
      ...
      categoryId: categoryData.filter(category => category.name === categoryOnlyNames.LAPTOPS)[0].id,
      brandId: brandsData.filter(brand => brand.name === brandOnlyName.HP)[0].id,
      processorSocketId: processorSockets.filter(processorSocket => processorSocket.name === 'FCBGA 1449')[0].id, 
      memoryRamTypeId: memoryRamType.filter(memory => memory.name === memoryRamTypeName.DDR4L)[0].id,
      memoryRamSlotQuantity: 2, 
      hasBluetooth: true, 
      hasWifiAdapter: true, 
    ...
    { 
      ...
      categoryId: categoryData.filter(category => category.name === categoryOnlyNames.LAPTOPS)[0].id,
      brandId: brandsData.filter(brand => brand.name === brandOnlyName.HP)[0].id,
      processorSocketId: processorSockets.filter(processorSocket => processorSocket.name === 'FCBGA 1440')[0].id, 
      memoryRamTypeId: memoryRamType.filter(memory => memory.name === memoryRamTypeName.DDR4L)[0].id,
      memoryRamSlotQuantity: 2, 
      hasBluetooth: true, 
      hasWifiAdapter: true, 
    ...
    { 
      ...
      categoryId: categoryData.filter(category => category.name === categoryOnlyNames.LAPTOPS)[0].id,
      brandId: brandsData.filter(brand => brand.name === brandOnlyName.DELL)[0].id, 
      processorSocketId: processorSockets.filter(processorSocket => processorSocket.name === 'FCBGA 1528')[0].id, 
      memoryRamTypeId: memoryRamType.filter(memory => memory.name === memoryRamTypeName.DDR4L)[0].id,
      memoryRamSlotQuantity: 2, 
      hasBluetooth: true, 
      hasWifiAdapter: true, 
    ...
    },    
    {
      ...
      processorSocketId: processorSockets.filter(processorSocket => processorSocket.name === 'FCBGA 1168')[0].id,
      memoryRamTypeId: memoryRamType.filter(memory => memory.name === memoryRamTypeName.DDR3)[0].id,
      memoryRamSlotQuantity: 1,
      hasBluetooth: true,
      hasWifiAdapter: true,
    ...
    },
    {
      ...
      categoryId: categoryData.filter(category => category.name === categoryOnlyNames.LAPTOPS)[0].id,
      brandId: brandsData.filter(brand => brand.name === brandOnlyName.LENOVO)[0].id,
      processorSocketId: processorSockets.filter(processorSocket => processorSocket.name === 'Socket 478')[0].id,
      memoryRamTypeId: memoryRamType.filter(memory => memory.name === memoryRamTypeName.DDR2L)[0].id, 
      memoryRamSlotQuantity: 2, 
      hasBluetooth: true, 
      hasWifiAdapter: true, 
    ...
    },
    {
      ...
      categoryId: categoryData.filter(category => category.name === categoryOnlyNames.LAPTOPS)[0].id,
      brandId: brandsData.filter(brand => brand.name === brandOnlyName.LENOVO)[0].id,
      processorSocketId: processorSockets.filter(processorSocket => processorSocket.name === 'FCBGA 1023')[0].id, 
      memoryRamTypeId: memoryRamType.filter(memory => memory.name === memoryRamTypeName.DDR3L)[0].id,
      memoryRamSlotQuantity: 2, 
      hasBluetooth: true, 
      hasWifiAdapter: true, 
