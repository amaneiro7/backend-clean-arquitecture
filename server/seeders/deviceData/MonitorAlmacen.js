...
const monitores = [
    ...
    },
    {
        ...
        activo: '3018283',
        statusId: statusData.filter(status => status.name === statusName.ENALMACEN)[0].id,
        categoryId: modelMonitor.filter(model => model.name === modelName.W1943SE)[0].categoryId,
        brandId: modelMonitor.filter(model => model.name === modelName.W1943SE)[0].brandId,
        modelId: modelMonitor.filter(model => model.name === modelName.W1943SE)[0].id,
        employeeId: null,
        locationId: locations.filter(location => location.name === almacenName.TORREBNC5DEJULIOALMACENPISO1)[0].id,
    },
    {
    ...
    },
    {
        ...
        activo: null,
        statusId: statusData.filter(status => status.name === statusName.ENALMACEN)[0].id,
        categoryId: modelMonitor.filter(model => model.name === modelName.E1920)[0].categoryId,
        brandId: modelMonitor.filter(model => model.name === modelName.E1920)[0].brandId,
        modelId: modelMonitor.filter(model => model.name === modelName.E1920)[0].id,
        employeeId: null,
        locationId: locations.filter(location => location.name === almacenName.TORREBNC5DEJULIOALMACENPISO1)[0].id,
    },
    {
