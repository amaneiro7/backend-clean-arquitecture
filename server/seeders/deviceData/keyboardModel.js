...
const keyboardModel = [
    {
        ...
        name: 'RT7D20',
        categoryId: 10,
        brandId: brands.filter(brand => brand.name === 'Dell')[0].id,
    ...
    },
    {
        ...
        name: 'GK-070006/U',
        categoryId: 10,
        brandId: brands.filter(brand => brand.name === 'Genius')[0].id,
    ...
    },
    {
        ...
        name: 'KB-0316',
        categoryId: 10,
        brandId: brands.filter(brand => brand.name === 'Hewlett-Packard')[0].id,
        inputType: inputTypes.filter(inputType => inputType.name === 'PS/2')[0].id
    },
    {
    ...
    },
    {
        ...
        name: 'KB-0225',
        categoryId: 10,
        brandId: brands.filter(brand => brand.name === 'IBM')[0].id,
        inputType: inputTypes.filter(inputType => inputType.name === 'PS/2')[0].id
    },
    {
        ...
        name: 'KU-0225',
        categoryId: 10,
        brandId: brands.filter(brand => brand.name === 'Lenovo')[0].id,
        inputType: inputTypes.filter(inputType => inputType.name === 'USB')[0].id
    },
    {
    ...
    },
    {
        ...
        name: '1366',
        categoryId: 10,
        brandId: brands.filter(brand => brand.name === 'Microsoft')[0].id,
        inputType: inputTypes.filter(inputType => inputType.name === 'USB')[0].id
    },
    {
